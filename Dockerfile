...
FROM --platform=${BUILDPLATFORM:-linux/amd64} nexus-docker-group.rnd.mendix.com/golang:1.24-alpine@sha256:d9db32125db0c3a680cfb7a1afcaefb89c898a075ec148fdc2f0f646cc2ed509 AS builder
